...
public class DDMFieldPersistenceTest {
	...
	@Test
	public void testCountByS_FN() throws Exception {
		_persistence.countByS_FN(RandomTestUtil.nextLong(), "");

		_persistence.countByS_FN(0L, "null");

		_persistence.countByS_FN(0L, (String)null);
	}
	...
	private void _assertOriginalValues(DDMField ddmField) {
		...
		Assert.assertEquals(
			...
			ReflectionTestUtil.invoke(
				ddmField, "getColumnOriginalValue",
				new Class<?>[] {String.class}, "fieldName"));
	}
