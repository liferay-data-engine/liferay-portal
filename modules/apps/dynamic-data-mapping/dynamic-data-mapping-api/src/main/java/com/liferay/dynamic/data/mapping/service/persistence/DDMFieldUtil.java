...
public class DDMFieldUtil {
	 ...
	 * @throws NoSuchFieldException if a matching ddm field could not be found
	 */
	public static DDMField findByS_FN(long storageId, String fieldName)
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFieldException {

		return getPersistence().findByS_FN(storageId, fieldName);
	}
	 ...
	 */
	public static DDMField fetchByS_FN(long storageId, String fieldName) {
		return getPersistence().fetchByS_FN(storageId, fieldName);
	}
	 ...
	 * @return the matching ddm field, or <code>null</code> if a matching ddm field could not be found
	 */
	public static DDMField fetchByS_FN(
		long storageId, String fieldName, boolean useFinderCache) {

		return getPersistence().fetchByS_FN(
			storageId, fieldName, useFinderCache);
	}
	 ...
	 */
	public static DDMField removeByS_FN(long storageId, String fieldName)
		throws com.liferay.dynamic.data.mapping.exception.NoSuchFieldException {

		return getPersistence().removeByS_FN(storageId, fieldName);
	}
	 ...
	 * @return the number of matching ddm fields
	 */
	public static int countByS_FN(long storageId, String fieldName) {
		return getPersistence().countByS_FN(storageId, fieldName);
	}
