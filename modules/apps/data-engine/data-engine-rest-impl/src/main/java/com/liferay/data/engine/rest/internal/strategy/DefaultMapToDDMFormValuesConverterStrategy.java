...
public class DefaultMapToDDMFormValuesConverterStrategy
	...
	public void setDDMFormFieldValues(
		...
		_createDDMFormFieldValues(
			dataRecordValues, ddmForm.getDefaultLocale(),
			ddmForm.getDDMFormFields(), ddmFormFieldValues, locale,
			StringPool.BLANK);
	...
	private void _createDDMFormFieldValues(
		...
		Map<String, DDMFormFieldValue> ddmFormFieldValues, Locale locale,
		String parentDataRecordValueKey) {
				...
				if (_isDataRecordValueFromDDMFormField(
					...
					if (ListUtil.isNotEmpty(
						...
						_createDDMFormFieldValues(
							...
							ddmFormField.getNestedDDMFormFields(),
							ddmFormFieldValues, locale, dataRecordValueKey);
					}
				}
			}
